...
typedef enum { SNOP, SBRA, SRET, SHALT, SLDC, SSTR, SBSR, SSWPRR, SLINK, SUNLINK, STRAP, SBRF, SLDL, SSTL, SAJS, SADD, SSUB, SMUL, SDIV, SMOD, SAND, SOR, SXOR, S_EQ, SNE, SLT, SGT, SLE, SGE, SLDR, SSTA, SLDA, SSTMA, SLDC_LABEL } ssminstr;
